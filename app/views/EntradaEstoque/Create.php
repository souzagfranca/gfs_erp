<script src="<?php echo URL_BASE . "assets/js/js_entrada_estoque.js" ?>"></script>
                ...
                <div class="col-12 mb-3">
                    <div class="border p-3 radius-4 pb-4">
                        <div class="rows">
                            ...
                            <div class="col-2">
                                <label class="text-label">Valor Unitário</label>
                                <input type="text" id="preco" value="" class="form-campo">
                            </div>
                            <div class="col-1">
                                <label class="text-label">Qt. Item</label>
                                <input type="text" value="1" id="qtde" class="form-campo">
                            </div>
                            <div class="col-3 ">
                                <label class="text-label">Local de Estoque</label>
                                <select class="form-campo" name="id_local_estoque" id="id_local_estoque"></select>
                            </div>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="left" width="290">Descrição</th>
                                ...
                                <tbody id="lista_entrada">
                                    <?php
                                    $total = 0;
                                    foreach ($lista as $tb_entrada_estoque) {
                                        $total += $tb_entrada_estoque->subtotal_entrada;
                                    ?>
                                        <tr>
                                            <td align="center"><?php echo $tb_entrada_estoque->id_entrada ?></td>
                                            <td align="center"><?php echo $tb_entrada_estoque->data_entrada ?></td>
                                            <td align="left" width="290"><?php echo $tb_entrada_estoque->desc_produto ?></td>
                                            <td align="center"><?php echo $tb_entrada_estoque->qtde_entrada ?></td>
                                            <td align="center"><?php echo $tb_entrada_estoque->valor_entrada ?></td>
                                            <td align="center"><?php echo $tb_entrada_estoque->subtotal_entrada ?></td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <td align="right" colspan="6"><b>Total:</b> <span id="total_entrada">R$ <?php echo $total ?></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
