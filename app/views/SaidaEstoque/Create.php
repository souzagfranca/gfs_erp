<script src="<?php echo URL_BASE . "assets/js/js_saida_estoque.js" ?>"></script>
                        ...
                        <div class="tabela-responsiva pb-4 mt-3">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tbody id="lista_saida">
                                    <?php
                                    $total = 0;
                                    foreach ($lista as $tb_saida_estoque) {
                                        $total += $tb_saida_estoque->subtotal_saida;
                                    ?>
                                        <tr>
                                            <td align="center"><?php echo $tb_saida_estoque->id_saida ?></td>
                                            <td align="center"><?php echo $tb_saida_estoque->data_saida ?></td>
                                            <td align="left" width="290"><?php echo $tb_saida_estoque->desc_produto ?></td>
                                            <td align="center"><?php echo $tb_saida_estoque->qtde_saida ?></td>
                                            <td align="center"><?php echo $tb_saida_estoque->valor_saida ?></td>
                                            <td align="center"><?php echo $tb_saida_estoque->subtotal_saida ?></td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <td align="right" colspan="6"><b>Total:</b> <span id="total_saida">R$ <?php echo $total ?></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
